...
example3 = {'chosen_action_prob': {'U': [0.5, 0.15, 0.2, 0.15], 'L': [0.2, 0.5, 0.15, 0.15],
                                  'R': [0.15, 0.2, 0.5, 0.15], 'D': [0.15, 0.15, 0.2, 0.5]},
           'finished_reward': 180,
           'opening_door_reward': {10: 25, 11: 20, 12: 15, 13: 10, 14: 30, 15: 20, 16: 10, 17: 15, 18: 20, 19: 25},
           'step_punishment': -0.5,
           'seed': 222}

example4 = {'chosen_action_prob': {'U': [0.7, 0.1, 0.1, 0.1], 'L': [0.1, 0.6, 0.2, 0.1],
                                  'R': [0.1, 0.2, 0.6, 0.1], 'D': [0.2, 0.1, 0.1, 0.6]},
           'finished_reward': 280,
           'opening_door_reward': {10: -15, 11: -15, 12: -15, 13: 20, 14: -15, 15: -15, 16: -15, 17: -15, 18: -15, 19: -15},
           'step_punishment': -4,
           'seed': 101}

example5 = {'chosen_action_prob': {'U': [0.5, 0.2, 0.2, 0.1], 'L': [0.1, 0.7, 0.1, 0.1],
                                  'R': [0.2, 0.1, 0.6, 0.1], 'D': [0.1, 0.2, 0.2, 0.5]},
           'finished_reward': 250,
...
problems = [problem1, problem2, problem3, problem4, problem5, problem6, problem7, problem8, problem9, problem10,
            problem11, problem12, problem13, problem14, problem15, problem16, problem17 ]
...
def main():
    ...
    for i, problem in enumerate(problems):
        ...
        for example in examples:
            solve_game(ind, problem, example, debug_mode)
